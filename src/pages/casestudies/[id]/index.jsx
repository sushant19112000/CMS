...
import BlogSearchComponent from '@/app/components/blogs/blogSearchComponent';
                ...
                <div className="d-md-flex ">
                    <div className="me-md-5">
                        <div className=''>
                            ...
                            <div className='mb-4'>
                                <img src={`/resources/casestudies/${data.blog.img}`} className='img-fluid rounded' />
                            </div>
                    ...
                    <div className="col-12  col-md-3" style={{ marginTop: '15px', padding: 0 }} >
                        ...
                        <div className="row justify-content-center" style={{ padding: 'none' }} >
                            <div className='col-8 col-md-12'>
                                ...
                                <div className="col">
                                    <Recommandation type={"casestudies"} category={data.blog.category} Id={data.blog.id} />
...
export async function getServerSideProps(context) {
    try {
        ...
        const apiUrl = `http://localhost:5000/api/casestudies/${id}`;
