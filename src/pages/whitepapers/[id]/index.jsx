...
import WhitepaperSearchComponent from '@/app/components/whitepaper/whitepaperSearchComponent';

const fetcher = (url) => fetch(url).then((res) => res.json());

export default function WhitepaperPage({ data, error }) {
                ...
                <div className="d-md-flex ">
                    <div className="me-md-5">
                        <div className=''>
                            ...
                            <div className='mb-4'>
                                <img src={`/resources/whitepaper/${data.blog.img}`} className='img-fluid rounded' />
                            </div>
                    ...
                    <div className="col-12  col-md-3" style={{ marginTop: '15px', padding: 0 }} >
                        ...
                        <div className="row justify-content-center" style={{ padding: 'none' }} >
                            <div className='col-8 col-md-12'>
                                <div className='mb-2'>
                                    <WhitepaperSearchComponent />
                                </div>
                                <div className="mb-3">
                                    <span style={{ fontSize: '20px' }}>Recommended</span>

                                </div>
                                <div className="col">
                                    <Recommandation type={"research"} category={data.blog.category} Id={data.blog.id} />
...
export async function getServerSideProps(context) {
    try {
        ...
        const apiUrl = `http://localhost:5000/api/whitepapers/${id}`;
