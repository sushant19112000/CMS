...
import ResearchSearchComponent from '@/app/components/research/researchSearchComponent';
import { Recommandation } from '@/app/components/recommandation';
import { convertToJson } from '@/app/middleware/convertToJson';

const fetcher = (url) => fetch(url).then((res) => res.json());
export default function ReasearchPage({ data, error }) {
                ...
                <div className="d-md-flex ">
                    <div className="me-md-5">
                        <div className=''>
                            ...
                            <div className='mb-4'>
                                <picture>
                                <img src={`/resources/research/${data.blog.img}`} className='img-fluid rounded' />
                                </picture>
                            </div>
...
export async function getServerSideProps(context) {
    try {
        ...
        const apiUrl = `http://localhost:5000/api/research/${id}`;
