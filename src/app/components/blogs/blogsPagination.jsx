      ...
      <div className="">
        <div className="row justify-content-center justify-content-lg-start">
          {currentBlogs.map((blog) => (
            <div className="col-10 col-md-6 col-lg-4 mb-3" key={blog.id}>
              <div className="card rounded ms-1  ms-md-0" style={{ margin: 0, border: "0", padding: 0, backgroundColor: 'transparent' }}>
                <picture className="blogimg rounded" style={{ objectFit: 'contain'}}>
                  <img className="rounded" src={`/resources/blogs/${blog.img}`} alt="Card image cap" style={{ width: '100%', height: '95%' }} />
                </picture>
