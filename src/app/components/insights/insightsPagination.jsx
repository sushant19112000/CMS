...
export const InsightsPagination = ({ data }) => {
            ...
            <div className="col-11 col-md-6 col-lg-4 mb-3" key={blog.id}>
              <div className="card rounded ms-2 ms-md-0" style={{ margin: 0, border: "0", padding: 0, backgroundColor: 'transparent' }}>
                ...
                <picture className="blogimg rounded" style={{ objectFit: 'contain'}}>
                  <img className="rounded" src={`/resources/insights/${blog.img}`} alt="Card image cap" style={{ width: '100%', height: '95%' }} />
                </picture>
                ...
                <div className="mt-2">
                  <NextLink href={`/insights/${blog.id}`} passHref style={{ textDecoration: "none", color: 'black' }}>
